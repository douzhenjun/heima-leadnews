...
public class GreenImageScan {
    ...
    private static final List<String> DEFAULT_SCENES = Arrays.asList("logo", "porn", "terrorism", "ad", "live");
    private static final Long DEFAULT_IMAGE_TIME_MILLISECOND = 1L;
    private static final Integer DEFAULT_INTERVAL = 1;
    private static final Integer DEFAULT_MAX_FRAMES = 1;
...
//    private String scenes;
    ...
    public Map<String, Object> imageScan(List<String> imageList) throws Exception {
        Map<String, Object> resultMap = new HashMap<>();
            
        // 创建 AccessKey ID和 AccessKey Secret，请参考 https://help.aliyun.com/document_detail/175144.html
        // 如果您使用的是RAM用户的AccessKey，还需要为子账号授予权限AliyunVIAPIFullAccess，请参考 https://help.aliyun.com/document_detail/145025.html
        // 从环境变量读取配置的AccessKey ID和 AccessKey Secret。运行代码示例前必须先配置环境变量。
        com.aliyun.imageaudit20191230.Client client = GreenImageScan.createClient(accessKeyId, secret);
        ...
        com.aliyun.imageaudit20191230.models.ScanImageAdvanceRequest scanImageAdvanceRequest = new com.aliyun.imageaudit20191230.models.ScanImageAdvanceRequest()
                .setTask(taskList)
                .setScene(DEFAULT_SCENES);
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
        try {
            ScanImageResponse scanImageResponse = client.scanImageAdvance(scanImageAdvanceRequest, runtime);
            return TeaModel.buildMap(scanImageResponse);
        } catch (com.aliyun.tea.TeaException teaException) {
            resultMap.put("code", teaException.getCode());
            resultMap.put("message", teaException.getMessage());
            return resultMap;
        } catch (Exception e) {
...
//    public Map imageScan2(List<byte[]> imageList) throws Exception {
