...
public class MinIOTest {
    ...
    public void test() throws FileNotFoundException {
        FileInputStream fileInputStream = new FileInputStream("C:\\Users\\DZJ\\Desktop\\3161-528a26.jpg");
        String path = fileStorageService.uploadImgFile("", "sex.jpg", fileInputStream);
...
//            MinioClient minioClient = MinioClient.builder().credentials("minio", "minio123").endpoint("http://192.168.88.130:9000").build();
//
//
//            //2.上传
